* NEED TO IMPORT FINAL DATA FILE OBTAINED FROM MAHARASHTRA AND DR. BHANU DUGGAL

/* Drop patients who underwent PCI in years outside of 2013 and 2015 to keep only relevant cohort; ptca refers to PCI */

keep if year_ptca==2013 | year_ptca==2015

/* Drop patients who did not receive stents; were unaffected by the price_cap and with missing data */

drop if STENT_TYPE=="NA" | PRICE_CAP==. | Sex_tmnt=="NA" | PUBLIC_PRIVATE==. | Age_tmnt==. | Education_level=="NA" | Diabetes=="NA" | US_CE_FDA==.
